...
console.log(Math.max(12, 34, 1, 67, 25));
console.log(Math.max(12, 34, 1, '67', 25));
console.log(Math.max(12, 34, 1, '67px', 25)); // not works

console.log(Math.min(12, 34, 1, 67, 25));
...
console.log('UA: ', Intl.NumberFormat('uk-UA', options).format(num));
console.log('SY: ', Intl.NumberFormat('ar-SY', options).format(num));
console.log(
  navigator.language,
...
// Set timeout
const ingridients = ['olives', 'mashrums'];
